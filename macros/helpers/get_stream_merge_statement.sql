{% macro get_stream_merge_statement(source, destination_table, unique_key, predicates=none) -%}
...
{{ get_merge_sql(destination_relation, source_relation, unique_key, dest_columns, predicates) }}
